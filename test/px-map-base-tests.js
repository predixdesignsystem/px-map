...
function runBaseTests() {
  px_map_1 = document.getElementById('px_map_1');

  suite('Base Automation Tests for px-map', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-map fixture is created', function() {
      assert.isTrue(document.getElementById('px_map_1') !== null);
    });
