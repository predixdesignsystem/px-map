...
import '../px-map-marker-symbol.js';
Polymer({
  _template: Polymer.html`
  <!-- Header -->
  <px-demo-header module-name="px-map-marker-symbol" parent-name="px-map" description="The px-map-marker-symbol subcomponent creates a marker with a specified icon at a given location on the map." mobile="" tablet="" desktop="">
  </px-demo-header>
  ...
  <px-demo-interactive>
    ...
    <px-demo-component slot="px-demo-component">
      <div style="height:400px; width:600px;display:flex">
        <px-map zoom="12" flex-to-size="" fit-to-markers="" disable-scroll-zoom="" disable-touch-zoom="" attribution-prefix="<a href=&quot;http://leafletjs.com&quot; title=&quot;A JS library for interactive maps&quot;>Leaflet</a> | © <a href=&quot;http://osm.org/copyright&quot;>OpenStreetMap contributors</a>">
          ...
          <px-map-marker-symbol lat="{{props.lat.value}}" lng="{{props.lng.value}}" type="{{props.type.value}}" icon="{{props.icon.value}}">
    ...
    <px-demo-component-snippet slot="px-demo-component-snippet" element-properties="{{props}}" element-name="px-map-marker-symbol" links-includes="[&quot;px-map/px-map.html&quot;,&quot;px-map/px-map-tile-layer.html&quot;,&quot;px-map/px-map-marker-symbol.html&quot;]">
    </px-demo-component-snippet>
  </px-demo-interactive>

  <!-- API Viewer -->
  <px-demo-api-viewer source="px-map-marker-symbol" api-source-file-path="px-map/px-map-api.json" mark-private="[[apiMarkPrivate]]">
  </px-demo-api-viewer>
